...
export default async function initSPSelectTeam() {
    ...
    const handleTeamClick = (e) => {
        ...
        document.getElementById('sp-select-team').style.backgroundColor = selectedTeam;
        if (selectedTeam == 'black')
            document.getElementById('sp-select-team').style.color = 'white';
        else 
            document.getElementById('sp-select-team').style.color = 'black';
