...
<header class="top">
  ...
  the whole tactic stops working.</p>
  <div class="meta">
...
<div class="stats">
  ...
  <div class="stat">
    <span class="stat-n">0<span class="u">/8</span></span>
    <span class="stat-t">Teams where a chump line survives an escorted tier-5, -6 or -7 force
    at any rate up to 30/s. One cheap escort unit per second breaks the tactic outright.</span>
  </div>
</div>
...
<section>
  ...
  {hold_matrix(4)}
  <p class="cap">No chump rate up to 30 per second holds an escorted tier-5, -6 or -7 force
  anywhere. Only tier-8 forces can be held, only at 30/s, and it costs about $36,000 and 20,000
  bodies &mdash; at &times;1 that is 1.26&times; the attacker&rsquo;s own spend, the only
  configuration measured where blocking is a losing trade.</p>
